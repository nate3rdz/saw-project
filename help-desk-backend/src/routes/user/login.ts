...
import IUserLoginInput, {
  userLoginInputBodySchema,
} from "../../interfaces/endpoints-input/user/IUserLogin.js";
import {
  IUserLoginOutput,
  userLoginOutputSchema,
} from "../../interfaces/endpoints-output/user/IUserLogin.js";
...
> {
  ...
  async fn(req: IUserLoginInput, res: Response): Promise<IUserLoginOutput> {
    ...
    if (!authData.success) throw new InternalAPIError("Unauthorized", 401);
