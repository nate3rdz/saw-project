...
import IUserCreateInput, { userCreateInputBodySchema } from "../../interfaces/endpoints-input/user/IUserCreate.js";
import { IUserCreateOutput } from "../../interfaces/endpoints-output/user/IUserCreate";

export class UserRegister extends Endpoint<IUserCreateInput, Response, IUserCreateOutput> {
    constructor() {
        super([]);
