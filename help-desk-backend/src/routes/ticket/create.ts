...
import ITicketCreateInput, { ticketCreateInputBodySchema } from "../../interfaces/endpoints-input/ticket/ITicketCreate.js";
import { ITicketCreateOutput, ticketCreateOutputSchema } from "../../interfaces/endpoints-output/ticket/ITicketCreate.js";
...
export class TicketCreate extends Endpoint<ITicketCreateInput, Response, ITicketCreateOutput> {
    constructor() {
    ...
    async fn(req: ITicketCreateInput, res: Response): Promise<ITicketCreateOutput> {
