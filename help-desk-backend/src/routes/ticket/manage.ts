...
import ITicketManageInput, {
  ticketManageInputBodySchema,
  ticketManageInputParamsSchema,
} from "../../interfaces/endpoints-input/ticket/ITicketManage.js";
...
export class TicketManage extends Endpoint<
  ITicketManageInput,
  Response,
  ITicketManageOutput
> {
